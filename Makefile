SRCS = srcs/main.c srcs/env.c srcs/echo.c srcs/utils.c srcs/utils_exec.c srcs/exec.c srcs/parsing.c srcs/pipe.c srcs/ft_split_parse.c \
	   ...
	   srcs/ft_split_parse_two.c srcs/here_doc_two.c srcs/utils_exec_second.c srcs/exit.c srcs/utils_two.c srcs/ft_split_free.c srcs/parsing_redirec_two.c srcs/pwd.c srcs/utils_hd.c
